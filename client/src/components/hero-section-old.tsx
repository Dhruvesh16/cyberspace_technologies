  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
          ...
          >
            <defs>
              <radialGradient id="globeGradient" cx="30%" cy="30%">
                <stop offset="0%" stopColor="rgba(66, 99, 235, 0.3)" />
                <stop offset="70%" stopColor="rgba(66, 99, 235, 0.1)" />
                <stop offset="100%" stopColor="rgba(66, 99, 235, 0.05)" />
              </radialGradient>
              <linearGradient id="wireGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="rgba(66, 99, 235, 0.6)" />
                <stop offset="50%" stopColor="rgba(52, 211, 153, 0.4)" />
                <stop offset="100%" stopColor="rgba(173, 58, 255, 0.3)" />
              </linearGradient>
            </defs>
            
            {/* Globe base */}
            <circle cx="200" cy="200" r="180" fill="url(#globeGradient)" stroke="rgba(66, 99, 235, 0.2)" strokeWidth="1"/>
            
            {/* Longitude lines */}
            <ellipse cx="200" cy="200" rx="180" ry="180" fill="none" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.6"/>
            <ellipse cx="200" cy="200" rx="135" ry="180" fill="none" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.5"/>
            <ellipse cx="200" cy="200" rx="90" ry="180" fill="none" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.4"/>
            <ellipse cx="200" cy="200" rx="45" ry="180" fill="none" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.3"/>
            
            {/* Latitude lines */}
            <ellipse cx="200" cy="200" rx="180" ry="135" fill="none" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.5"/>
            <ellipse cx="200" cy="200" rx="180" ry="90" fill="none" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.4"/>
            <ellipse cx="200" cy="200" rx="180" ry="45" fill="none" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.3"/>
            <line x1="20" y1="200" x2="380" y2="200" stroke="url(#wireGradient)" strokeWidth="1" opacity="0.6"/>
          </motion.svg>
        </motion.div>
          ...
          <svg className="w-full h-full" viewBox="0 0 1200 800">
            <defs>
              <linearGradient id="networkGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="rgba(66, 99, 235, 0.4)" />
                <stop offset="50%" stopColor="rgba(52, 211, 153, 0.3)" />
                <stop offset="100%" stopColor="rgba(173, 58, 255, 0.2)" />
              </linearGradient>
            </defs>
            
            {/* Connection paths */}
            <motion.path 
              d="M 100 150 Q 300 100 500 180 T 900 200"
            ...
            />
            <motion.path 
              d="M 50 400 Q 250 350 450 420 T 850 450"
              stroke="url(#networkGradient)"
              strokeWidth="1.5"
              fill="none"
              initial={{ pathLength: 0, opacity: 0 }}
            ...
            />
            <motion.path 
              d="M 150 600 Q 400 550 650 580 T 1000 620"
              stroke="url(#networkGradient)"
              strokeWidth="1.5"
              fill="none"
              initial={{ pathLength: 0, opacity: 0 }}
        ...
        {[
          ...
          <motion.div
            ...
            style={{
              left: `${node.x}%`,
              top: `${node.y}%`,
              boxShadow: "0 0 15px rgba(66, 99, 235, 0.8)"
            }}
            initial={{ scale: 0, opacity: 0 }}
            animate={{ 
              scale: [0, 1.5, 1],
          ...
          <svg className="w-full h-full" viewBox="0 0 1200 800">
            <defs>
              <pattern id="professionalGrid" width="80" height="80" patternUnits="userSpaceOnUse">
                <path d="M 80 0 L 0 0 0 80" fill="none" stroke="rgba(66, 99, 235, 0.1)" strokeWidth="0.5"/>
              </pattern>
            </defs>
        ...
        {/* Floating Tech Icons */}
        <motion.div 
          className="absolute top-1/4 left-1/6 w-8 h-8 opacity-20"
          animate={{
            y: [-10, 10, -10],
            rotate: [0, 180, 360],
            opacity: [0.1, 0.3, 0.1]
        ...
        <motion.div 
          className="absolute top-2/3 left-1/12 w-6 h-6 opacity-15"
          animate={{
            y: [15, -15, 15],
            x: [5, -5, 5],
        ...
        >
          <Zap className="w-full h-full text-cyber-purple" />
        </motion.div>
      </div>
